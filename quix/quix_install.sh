...
FILE_NODES=~/MasterNodes/quix/quix_nodes.txt

# LINK TO DOWNLOAD DAEMON
COIN_TGZ_ZIP=https://github.com/quixcoin/quix/releases/download/0.12.1.1/QUIX_LINUX.tar.gz

# SET FOLDER IF UNZIP DAEMON IS ON SUBFOLDER?
COIN_SUBFOLDER=QUIX_LINUX
