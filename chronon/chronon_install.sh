...
COIN_NAME=chronon
COLATERAL=1000QUIX
CONFIG_FILE=chronon.conf

# ALWAYS START WITH ~/. AND DEFAULT COIN FOLDER
CONFIG_FOLDER=~/.chronon
COIN_DAEMON=chronond
COIN_CLI=chronon-cli
COIN_TX=chronon-tx
COIN_QT=
MAX_CONNECTIONS=30
LOGINTIMESTAMPS=1
...
FILE_NODES=~/MasterNodes/chronon/chronon_nodes.txt

# LINK TO DOWNLOAD DAEMON
COIN_TGZ_ZIP=https://github.com/ChrononGroup/Chronon/releases/download/v1/Chronon-lin-bin.tar.gz
